...
class TestClass(unittest.TestCase):
    ...
    def test_3(self):
        test(self, ["RangeModule","addRange","removeRange","removeRange","addRange","removeRange","addRange","queryRange","queryRange","queryRange"],
...
'''
Runtime: 384 ms, faster than 95.08% of Python3 online submissions for Range Module.
Memory Usage: 18.6 MB, less than 61.51% of Python3 online submissions for Range Module.
'''
