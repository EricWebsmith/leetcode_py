...
def test(testObj: unittest.TestCase, n: int, queries: list[list[int]], expected: list[list[int]]) -> None:
    so = Solution()
...
class TestClass(unittest.TestCase):
    ...
    def test_3(self):
        self.maxDiff = None
        test(self,   13,
             [[3, 1, 7, 3], [7, 5, 7, 8], [4, 12, 6, 12], [2, 8, 6, 11], [9, 11, 10, 11], [9, 3, 11, 11],
              [0, 12, 10, 12], [10, 5, 11, 12], [4, 7, 6, 12], [0, 2, 9, 6], [12, 7, 12, 11], [2, 7, 3, 8],
              [2, 9, 6, 12], [10, 7, 10, 12], [11, 6, 11, 7], [3, 2, 12, 9]],
