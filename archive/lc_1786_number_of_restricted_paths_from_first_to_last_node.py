...
'''
Runtime: 2302 ms, faster than 90.28% of Python3 online submissions for Number of Restricted Paths From First to Last Node.
Memory Usage: 54.9 MB, less than 78.24% of Python3 online submissions for Number of Restricted Paths From First to Last Node.
'''
