...
'''
Runtime: 574 ms, faster than 90.00% of Python3 online submissions for Handshakes That Don't Cross.
Memory Usage: 13.8 MB, less than 98.89% of Python3 online submissions for Handshakes That Don't Cross.
'''
