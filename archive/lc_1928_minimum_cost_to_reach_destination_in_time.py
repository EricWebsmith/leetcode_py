...
def test(testObj: unittest.TestCase, maxTime: int, edges: List[List[int]], passingFees: List[int], expected:int) -> None:
...
class TestClass(unittest.TestCase):
    ...
    def test_1(self):
        test(self,   30,  [[0,1,10],[1,2,10],[2,5,10],[0,3,1],[3,4,10],[4,5,15]],  [5,1,2,20,20,3], 11)

    def test_2(self):
        test(self,   29,  [[0,1,10],[1,2,10],[2,5,10],[0,3,1],[3,4,10],[4,5,15]],  [5,1,2,20,20,3], 48)

    def test_3(self):
        test(self,   25,  [[0,1,10],[1,2,10],[2,5,10],[0,3,1],[3,4,10],[4,5,15]],  [5,1,2,20,20,3], -1)
...
[274,630,138,293,592,832,255,72,877,611,272,59,956,23,443,626,989,290,864,487,433,447,861,829,70,190,220,787,696,35,954,653,844,776,440,977,870,425,364,964,364,524,933,152,184,809,232,235,830,965], 1262)
...
'''
Runtime: 410 ms, faster than 94.57% of Python3 online submissions for Minimum Cost to Reach Destination in Time.
Memory Usage: 15 MB, less than 21.72% of Python3 online submissions for Minimum Cost to Reach Destination in Time.
'''
